export const metadata = {
  ...
  description: 'Terms of service for MotorHomeInsurance.co.nz. Please review our terms before using our lead generation service.',
};
    ...
    <>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-3xl mx-auto prose prose-lg max-w-none text-slate-700">
          ...
          <p>
            MotorHomeInsurance.co.nz is a lead generation service operated by Cover4You Limited, a New Zealand company. We connect motorhome owners with licensed insurance brokers and providers who can offer insurance quotes and coverage.
          </p>
          <p>
